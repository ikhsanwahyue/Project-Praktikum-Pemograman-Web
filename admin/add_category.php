...
if(isset($_POST['add_category'])) {
    ...
    $check_stmt = $connection->prepare("SELECT kategori_id FROM kategori WHERE kategori = ?");
    ...
    if($check_stmt->num_rows > 0) {
        ...
        $stmt = $connection->prepare("INSERT INTO kategori (kategori, deskripsi) VALUES (?, ?)");
...
<head>
    ...
    <title>Tambah Kategori - Sistem Manajemen Perpustakaan</title>
...
<body>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <p class="text-muted mb-0">Tambahkan kategori baru untuk mengorganisir buku dalam sistem perpustakaan digital</p>
                                </div>
            ...
            <div class="row">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="char-counter">
                                            <span id="categoryCounter">0</span>/50 karakter
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="char-counter">
                                            <span id="descCounter">0</span>/200 karakter
                                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card form-card animate-fade-in-up" style="animation-delay: 0.2s;">
                        ...
                        <div class="form-body">
                            <div class="category-preview">
                                ...
                                <h6 id="previewCategory" class="mb-2">Nama Kategori</h6>
                    ...
                    <div class="card form-card animate-fade-in-up" style="animation-delay: 0.4s;">
                        ...
                        <div class="form-body">
                            <?php
                            $total_categories = $connection->query("SELECT COUNT(*) as total FROM kategori")->fetch_assoc()['total'];
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="badge bg-primary"><?php echo $total_categories; ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="text-muted">Kategori Aktif</span>
                                <span class="badge bg-success"><?php echo $categories_with_books; ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-muted">Kategori Baru</span>
    ...
    <script>
        ...
        function updatePreview() {
            const category = categoryInput.value || 'Nama Kategori';
