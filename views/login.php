...
<html lang="en">
  ...
  <body>
    <div class="login-card">
      ...
      <p class="text-muted mb-4">Login to Azizi.io</p>

        <div class="mb-3">
            <label for="Google" class="form-label">Login dengan Google</label>
          <input type="onclick" class="form-control" id="email" name="email" placeholder="Continue With Google" required>
        </div>
